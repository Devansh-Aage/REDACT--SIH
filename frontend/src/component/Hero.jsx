    ...
    >
      <div className="container flex flex-col-reverse items-center mx-auto space-y-8 md:space-y-0 md:flex-row">
        <div className="flex flex-col space-y-8 md:w-1/2">
          ...
          <p className="max-w-sm text-center text-lg text-gray-200 md:text-left md:max-w-lg">
            Secure Your Data, Effortlessly.
          </p>
          <div className="flex justify-center md:justify-start">
            <Link
              to="/signin"
              className="p-3 px-6 pt-2 text-white bg-red-500 hover:bg-red-600 rounded-full shadow-lg transition-colors duration-300"
            >
              Get Started
            </Link>
          </div>
